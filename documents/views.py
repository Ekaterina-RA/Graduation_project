...
@extend_schema_view(
    list=extend_schema(
        ...
        description="Получить список всех документов. " "Пользователь видит только свои, админ — все.",
        tags=["documents"],
        parameters=[
            OpenApiParameter(name="status", type=str, description="Фильтр по статусу: pending, approved, rejected"),
            OpenApiParameter(name="search", type=str, description="Поиск по названию и описанию"),
        ],
    ),
