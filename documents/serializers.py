...
class DocumentListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Document
        fields = ['id', 'title', 'file_type', 'file_size_display',
                  'status', 'status_display', 'username', 'created_at']
...
class DocumentDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'title', 'description', 'file', 'file_url',
                  'file_type', 'file_size', 'status', 'status_display',
                  'admin_comment', 'username', 'user_email',
